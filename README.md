...
For detailed version history, changes, and release notes, please see [CHANGELOG.md](CHANGELOG.md).

**Current Version:** v2.0.0 - Major refactoring with enhanced Windows support, modular architecture, and collection processing capabilities.
